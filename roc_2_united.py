...
df_train = pd.read_csv("payloads/united/skip_gram/train.csv")
X_train = df_train.loc[:, df_train.columns != 'Label']

#Change name of test dataset here
df_test = pd.read_csv("payloads/SQLi_2/plain/test.csv")
X_test = df_test.loc[:, df_test.columns != 'Label']
y_test = df_test['Label']

X_test = skip_gram(X_train, X_test, "united")
...
plt.title("Train: United Test: SQL2", fontsize = 15)
...
plt.savefig('roc_curves/u_2.png', dpi=2000, bbox_inches='tight')
plt.show()
