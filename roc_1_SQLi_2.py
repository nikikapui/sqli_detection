...
df_test = pd.read_csv("payloads/SQLi_2/TF_IDF/test.csv")
...
df_test = pd.read_csv("payloads/SQLi_2/skip_gram/test.csv")
X_test = df_test.loc[:, df_test.columns != 'Label']
y_test = df_test['Label']
...
plt.savefig('roc_curves/SQLi_2.png', dpi=2000, bbox_inches='tight')
plt.show()
